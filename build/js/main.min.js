...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _slider.heroSlider)();
    (0, _slider.toursSlider)();
    (0, _slider.educationSlider)();
    (0, _slider.reviewsSlider)();
    (0, _slider.advantagesSlider)();
    (0, _slider.gallerySlider)();
    (0, _slider.handleResize)();
  });
});
...
},{"./modules/burger-menu":2,"./modules/form-validate/form":4,"./modules/scroll":10,"./modules/slider":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";

var navToggle = document.querySelector('.header__nav-toggle');
var navHeader = document.querySelector('.header__nav');
var openToggle = document.querySelector('[data-toggle="is-opened"]');
var closeToggle = document.querySelector('[data-toggle="is-closed"]');
var navList = document.querySelector('.header__nav-list');
var headerLogo = document.querySelector('[data-header="logo"]');
var headerTel = document.querySelector('[data-header="tel"]');
...
var scrollButtonTours = document.querySelectorAll('[data-nav="tours"]');
var scrollTargetTours = document.querySelector('[data-tours]');
var scrollButtonEducation = document.querySelectorAll('[data-nav="education"]');
var scrollTargetEducation = document.querySelector('[data-education]');
var scrollButtonAbout = document.querySelectorAll('[data-nav="about"]');
var scrollTargetAbout = document.querySelector('[data-about]');
var scrollButtonReviews = document.querySelectorAll('[data-nav="reviews"]');
var scrollTargetReviews = document.querySelector('[data-reviews]');
var scrollButtonPhotos = document.querySelectorAll('[data-nav="photos"]');
var scrollTargetPhotos = document.querySelector('[data-photos]');
var scrollButtonContacts = document.querySelectorAll('[data-nav="contacts"]');
var scrollTargetContacts = document.querySelector('[data-contacts]');
scrollButtonTours.forEach(function (button) {
  return button.addEventListener('click', scrollTours);
});
scrollButtonEducation.forEach(function (button) {
  return button.addEventListener('click', scrollEducation);
});
scrollButtonAbout.forEach(function (button) {
  return button.addEventListener('click', scrollAbout);
});
scrollButtonReviews.forEach(function (button) {
  return button.addEventListener('click', scrollReviews);
});
scrollButtonPhotos.forEach(function (button) {
  return button.addEventListener('click', scrollPhotos);
});
scrollButtonContacts.forEach(function (button) {
  return button.addEventListener('click', scrollContacts);
});
function scrollTours() {
  scrollTargetTours.scrollIntoView({
    block: 'center',
    behavior: 'smooth'
  });
}
function scrollEducation() {
  scrollTargetEducation.scrollIntoView({
    block: 'center',
    behavior: 'smooth'
  });
}
function scrollAbout() {
  scrollTargetAbout.scrollIntoView({
    block: 'center',
    behavior: 'smooth'
  });
}
function scrollReviews() {
  scrollTargetReviews.scrollIntoView({
    block: 'center',
    behavior: 'smooth'
  });
}
function scrollPhotos() {
  scrollTargetPhotos.scrollIntoView({
    block: 'center',
    behavior: 'smooth'
  });
}
function scrollContacts() {
  scrollTargetContacts.scrollIntoView({
    block: 'center',
    behavior: 'smooth'
  });
}
...
exports.educationSlider = educationSlider;
exports.gallerySlider = gallerySlider;
exports.handleResize = void 0;
exports.heroSlider = heroSlider;
exports.reviewsSlider = reviewsSlider;
exports.toursSlider = toursSlider;
require("../vendor");
var hero = document.querySelector('.hero__swiper');
var tours = document.querySelector('.tours__swiper');
var education = document.querySelector('.education__swiper');
var reviews = document.querySelector('.reviews__swiper');
var advantages = document.querySelector('.advantages__swiper');
var gallery = document.querySelector('.gallery__swiper');
function heroSlider() {
  if (hero) {
...
var handleResize = exports.handleResize = function handleResize() {
  destroySwiper();
};
window.addEventListener('resize', handleResize);

},{"../vendor":14}],12:[function(require,module,exports){
"use strict";
...
},{"./vendor/focus-visible-polyfill":15,"./vendor/swiper":16}],15:[function(require,module,exports){
"use strict";
