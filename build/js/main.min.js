...
var scrollButtonTours = document.querySelector('[data-nav="tours"]');
var scrollTargetTours = document.querySelector('[data-tours]');
var scrollButtonEducation = document.querySelector('[data-nav="education"]');
var scrollTargetEducation = document.querySelector('[data-education]');
var scrollButtonAbout = document.querySelector('[data-nav="about"]');
var scrollTargetAbout = document.querySelector('[data-about]');
var scrollButtonReviews = document.querySelector('[data-nav="reviews"]');
var scrollTargetReviews = document.querySelector('[data-reviews]');
var scrollButtonPhotos = document.querySelector('[data-nav="photos"]');
var scrollTargetPhotos = document.querySelector('[data-photos]');
var scrollButtonContacts = document.querySelector('[data-nav="contacts"]');
